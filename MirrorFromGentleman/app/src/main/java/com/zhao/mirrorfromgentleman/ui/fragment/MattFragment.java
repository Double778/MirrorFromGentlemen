...
import com.zhao.mirrorfromgentleman.ui.adapter.rvadapter.MattRvadapter;
...
public class MattFragment extends BaseFragment implements View.OnClickListener, MattRvadapter.MyRvOnclickListener {
    //弹出这个ppp需要的点击
    ...
    private MattRvadapter mattRvadapter;
    ...
    public MattFragment(String titles) {
        this.titles = titles;
    }
...
//        }, params);
        ...
        mattRvadapter.setBean(productInforBean);
        recyclerView.setAdapter(mattRvadapter);

        mattRvadapter.setMyRvOnclickListener(this);
