...
public class ProjectRvadapter extends RecyclerView.Adapter<ProjectRvadapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.frm_project_item_rv, parent, false);
...
//            textView = (TextView) itemView.findViewById(R.id.Rv_tv);
            iv= (ImageView) itemView.findViewById(R.id.frm_project_item_iv);
        }
    }
