...
public class ProjectFragment extends BaseFragment implements View.OnClickListener, ProjectRvadapter.MyRvOnclickListener {
    //弹出这个ppp需要的点击
    ...
    public ProjectFragment(String titles) {
        this.titles = titles;
    }
