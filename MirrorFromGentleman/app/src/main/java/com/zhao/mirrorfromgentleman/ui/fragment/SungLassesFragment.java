...
import com.zhao.mirrorfromgentleman.ui.adapter.rvadapter.SungLassesRvadapter;
...
public class SungLassesFragment extends BaseFragment implements View.OnClickListener, SungLassesRvadapter.MyRvOnclickListener {
    //弹出这个ppp需要的点击
    ...
    public SungLassesFragment(String titles) {
        this.titles = titles;
    }
