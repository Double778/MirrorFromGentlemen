...
public class AllFragment extends BaseFragment implements View.OnClickListener, AllRvadapter.MyRvOnclickListener {
    //弹出这个ppp需要的点击
    ...
    private AllRvadapter allRvadapter;
    ...
    public AllFragment(String titles) {
        this.titles = titles;
    }
...
//        controlViewpager = (ControlViewpager) context;
    ...
    public void initData() {
        ...
        allRvadapter = new AllRvadapter(context);
...
//
        ...
        allRvadapter.setBean(productInforBean);
        recyclerView.setAdapter(allRvadapter);

        allRvadapter.setMyRvOnclickListener(this);
    }
